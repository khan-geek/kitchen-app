          ...
          <div className="col-lg-8 text-center">
            <div className="hero-section rounded-4 mb-5">
              ...
              <p className="lead mb-5">
                Connect with local chefs and discover delicious homemade meals, 
                or share your culinary skills with food lovers in your community.
              </p>
            </div>
              ...
              <div className="col-md-6">
                ...
                >
                  <div className="card-body text-center p-5">
                    ...
                    <h3 className="card-title mb-3">I'm a Chef</h3>
              ...
              <div className="col-md-6">
                ...
                >
                  <div className="card-body text-center p-5">
                    ...
                    <h3 className="card-title mb-3">I'm a Customer</h3>
                    <p className="card-text mb-4">
